...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    private RelativeLayout searchBarCardView;
    ...
    private void init(AttributeSet attrs) {
        ...
        arrowIconRes = array.getResourceId(R.styleable.MaterialSearchBar_mt_backIconDrawable, R.drawable.ic_arrow_forward_black_48dp);
        ...
        //View References
        searchBarCardView = (RelativeLayout) findViewById(R.id.mt_container);
    ...
    private void postSetup() {
        setCustomfontToSearchbar(getContext());
        setupTextColors();
...
//        }
    ...
    public void setNavButtonEnabled(boolean navButtonEnabled) {
        ...
        if (navButtonEnabled) {
            ...
            ((LayoutParams) inputContainer.getLayoutParams()).rightMargin = (int) (50 * destiny);
            ...
            ((LayoutParams) inputContainer.getLayoutParams()).rightMargin = (int) (0 * destiny);
...
//        RelativeLayout cardView = (RelativeLayout) findViewById(R.id.mt_container);
//        cardView.setCardElevation(elevation);
    ...
    public void setCustomfontToSearchbar(Context ctx) {

        Typeface myFont = Typeface.createFromAsset(ctx.getAssets(), "fonts/byekan.ttf");
        searchEdit.setTypeface(myFont);
        placeHolder.setTypeface(myFont);
